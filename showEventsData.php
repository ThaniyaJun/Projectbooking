<?php
include './conDB/conn.php'; // เรียกใช้งานไฟล์เชื่อมต่อกับฐานข้อมูล
            ...
            <div class="col-lg-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!-- <button class="btn btn-default btn-sm "> ชื่อผู้จอง</button>
                        <div class="alert alert-success">
                            <?php echo $rs->staff_name; ?>
                        </div> -->
                        <button class="btn btn-default btn-sm"> วัน-เวลาที่จอง </button>
                        ...
                        <!-- <button class="btn btn-default btn-sm"> จุดประสงค์ </button>
                        <div class="alert alert-info">
                            <?php echo $rs->purpose; ?>
                        </div>
